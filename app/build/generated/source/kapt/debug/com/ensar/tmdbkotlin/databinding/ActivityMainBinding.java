package com.ensar.tmdbkotlin.databinding;
import com.ensar.tmdbkotlin.R;
import com.ensar.tmdbkotlin.BR;
...
public class ActivityMainBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private com.ensar.tmdbkotlin.ui.main.MainActivityViewModel mViewModel;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.ensar.tmdbkotlin.ui.main.MainActivityViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.ensar.tmdbkotlin.ui.main.MainActivityViewModel ViewModel) {
    ...
    @Nullable
    public com.ensar.tmdbkotlin.ui.main.MainActivityViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected void executeBindings() {
        ...
        com.ensar.tmdbkotlin.ui.main.MainActivityViewModel viewModel = mViewModel;
    ...
    public static ActivityMainBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityMainBinding>inflate(inflater, com.ensar.tmdbkotlin.R.layout.activity_main, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityMainBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.ensar.tmdbkotlin.R.layout.activity_main, null, false), bindingComponent);
    }
    @NonNull
